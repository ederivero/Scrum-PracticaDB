...
select concat(anyo_inicio,"-",anyo_fin) as periodo,id_asignatura,c.nombre as materia,per.nombre as nombre_de_profesor 
from alumno_se_matricula_asignatura as a
left join periodo_academico as b on a.id_periodo_academico=b.id
left join asignatura as c on b.id=c.id
